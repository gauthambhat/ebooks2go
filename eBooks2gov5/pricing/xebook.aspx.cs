...
{
    public partial class xebook : System.Web.UI.Page
    {
        ...
        protected void getpcid(int _pcid)
        {
            ...
            lblfootandnotedefaultqty.Text = dtpc.Rows[0]["pcdfootnotes"].ToString();
            lblebookpcdhplinks.Text = dtpc.Rows[0]["pcdhplinks"].ToString();
            //basics packages includes complete
           ...
           //offers complete
            ...
            //customize your products complete

            //Does Your Book contain any of the following elements start
            ...
            //Does Your Book contain any of the following elements complete

            //Does Your Book Need Audio/Video Elements start
            ...
            //Does Your Book Need Audio/Video Elements complete

            //Does your Book need Cover design start
            ...
            //Does your Book need Cover design complete
            ...
            //Choose product(s) complete
        }
        #endregion

        #region eBook page calculation
        ...
        private void calculatecost()
        {
            ...
            if (count > 0)
            {
                ...
                txteBookhdnPckCst.Text = roundofdecimalpoints(Cartprice);
        ...
        private decimal cartpricewithavelement()
        {
            if (!string.IsNullOrEmpty(txteBookeachavcost.Text))
            {
                ...
                hdneBookavunitcost.Text = lbleBookavunitcost.Text;
                hdneBookavtotalcost.Text = lbleBookavtotalcost.Text;
                return avprice;
            }
            else
            {
        ...
        private decimal gethyperlinkvalues(int count)
        {
            if (!string.IsNullOrEmpty(txteBookcustpcdhplinks.Text))
            {
                if (Convert.ToInt32(txteBookcustpcdhplinks.Text) > Convert.ToInt32(lblebookcustpcdhplinks.Text))
                {
                    ...
                    hdneBookadditionalpcdhplinksunitcost.Text = lbleBookadditionalpcdhplinksunitcost.Text;
                    hdneBookpcdhplinksadditionalcost.Text = lbleBookpcdhplinksadditionalcost.Text;
                    return linksprice;
                }
                else
                {
        ...
        private decimal getfootandendnotesvalues(int count)
        {
            if (!string.IsNullOrEmpty(txteBookfootnotesandendnotes.Text))
            {
                if (Convert.ToInt32(txteBookfootnotesandendnotes.Text) > Convert.ToInt32(lblebookpcdfootnotes.Text))
                {
                    ...
                    hdneBookadditionalfootandendnotesunitcost.Text = lbleBookadditionalfootandendnotesunitcost.Text;
                    hdneBookfootandendnotesadditionalcost.Text = lbleBookfootandendnotesadditionalcost.Text;
        ...
        private decimal getimagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txteBookcustpcdimages.Text))
            {
                if (Convert.ToInt32(txteBookcustpcdimages.Text) > Convert.ToInt32(lblebookcustpcdimages.Text))
                {
                    ...
                    hdneBookadditionalimagesunitcost.Text = lbleBookadditionalimages.Text;
                    hdneBookimagesadditionalcost.Text = lbleBookadditionalimagesunitcost.Text;
                    return Imageprice;
                }
                else
                {
        ...
        private decimal getpagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txtebookcustpcdpages.Text))
            {
                if (Convert.ToInt32(txtebookcustpcdpages.Text) > Convert.ToInt32(lblebookcustpcdpages.Text))
                {
                    ...
                    hdneBookadditonalpagesunitcost.Text = lbleBookadditonalpagesunitcost.Text;
                    hdneBookpageadditionalcost.Text = lbleBookpageadditionalcost.Text;
                    return PagePrice;
                }
                else
                {
        ...
        #region store ebookpage values to session
        ...
        private void addtosession(DataTable dteBookcart)
        {
            ...
            if (!string.IsNullOrEmpty(txtebookcustpcdpages.Text))
            {
                ...
                dr["unitcost"] = hdneBookadditonalpagesunitcost.Text;
                dr["totalcost"] = hdneBookpageadditionalcost.Text;
                dteBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txteBookcustpcdimages.Text))
            {
                ...
                dr["unitcost"] = hdneBookadditionalimagesunitcost.Text;
                dr["totalcost"] = hdneBookimagesadditionalcost.Text;
                dteBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txteBookfootnotesandendnotes.Text))
            {
                ...
                dr["unitcost"] = hdneBookadditionalfootandendnotesunitcost.Text;
                dr["totalcost"] = hdneBookfootandendnotesadditionalcost.Text;
                dteBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txteBookcustpcdhplinks.Text))
            {
                ...
                dr["unitcost"] = hdneBookadditionalpcdhplinksunitcost.Text;
                dr["totalcost"] = hdneBookpcdhplinksadditionalcost.Text;
                dteBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txteBookeachavcost.Text))
            {
                ...
                dr["unitcost"] = hdneBookavunitcost.Text;
                dr["totalcost"] = hdneBookavtotalcost.Text;
                dteBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            Session["eBookcarttotal"] = roundofdecimalpoints(Convert.ToDecimal(txteBookhdnPckCst.Text));
            ...
            decimal eBookofferselected = Math.Ceiling((100 * eBookdiscountonbasepkg) / calculateproductprice());
            Session["eBookofferselected"] = eBookofferselected.ToString();
        ...
        #region bind cartvalues to eBook form
