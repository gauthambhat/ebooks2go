...
{
    public partial class xenhancedebook : System.Web.UI.Page
    {
        ...
        private void calculatecost()
        {
            ...
            if (count > 0)
            {
                ...
                txtEnhanceeBookhdnPckCst.Text = roundofdecimalpoints(Cartprice);
            }
            else
            { 
                //To clear all start
        ...
        private decimal getpagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txtEnhancedeBookcustpcdpages.Text))
            {
                if (Convert.ToInt32(txtEnhancedeBookcustpcdpages.Text) > Convert.ToInt32(lblenhancedebookpcdpages.Text))
                {
                    ...
                    hdnEnhancedeBookpageadditionalunit.Text = lblEnhancedeBookpageadditionalunit.Text;
                    hdnEnhancedeBookpageadditionalunitscost.Text = lblEnhancedeBookpageadditionalunitscost.Text;
                    return PagePrice;
                }
                else
                {
        ...
        private void clearpagevalues()
        {
           ...
           hdnEnhancedeBookpageadditionalunit.Text = "";
            hdnEnhancedeBookpageadditionalunitscost.Text = "";
        }
        #endregion
        ...
        private decimal gethyperlinkvalues(int count)
        {
            if (!string.IsNullOrEmpty(txtEnhancedeBookcustpcdhplinks.Text))
            {
                if (Convert.ToInt32(txtEnhancedeBookcustpcdhplinks.Text) > Convert.ToInt32(lblenhancedebookcustpcdhplinks.Text))
                {
                    ...
                    hdnEnhancedeBooklinksadditionalunits.Text = lblEnhancedeBooklinksadditionalunits.Text;
                    hdnEnhancedeBooklinksadditionalunitscost.Text = lblEnhancedeBooklinksadditionalunitscost.Text;
                    return linksprice;
                }
                else
                {
        ...
        private void clearlinksvalues()
        {
            ...
            hdnEnhancedeBooklinksadditionalunits.Text = "";
            hdnEnhancedeBooklinksadditionalunitscost.Text = "";
        }
        #endregion
        ...
        private decimal cartpricewithavelement()
        {
            if (!string.IsNullOrEmpty(txtEnhancedeBookavcost.Text))
            {
                ...
                hdnEnhancedeBookavunitcost.Text = lblEnhancedeBookavunitcost.Text;
                hdnEnhancedeBookavtotalcost.Text = lblEnhancedeBookavtotalcost.Text;
                return avprice;
            }
            else
            {
        ...
        private void clearavvalues()
        {
            ...
            hdnEnhancedeBookavunitcost.Text = "";
            hdnEnhancedeBookavtotalcost.Text = "";
        }
        #endregion
        ...
        private decimal cartpricewithraelement()
        {
            if (!string.IsNullOrEmpty(txtEnhancedeBookReadaloud.Text))
            {
                ...
                hdnEnhancedeBookReadaloudunitcost.Text = lblEnhancedeBookReadaloudunitcost.Text;
                hdnEnhancedeBookReadaloudtotalcost.Text = lblEnhancedeBookReadaloudtotalcost.Text;
                return raprice;
            }
            else
            {
        ...
        private void clearravalues()
        {
            ...
            hdnEnhancedeBookReadaloudunitcost.Text = "";
            hdnEnhancedeBookReadaloudtotalcost.Text = "";
        }
        #endregion
        ...
        private void addtosession(DataTable dtenhancedeBookcart)
        {
            ...
            if (!string.IsNullOrEmpty(txtEnhancedeBookcustpcdpages.Text))
            {
                ...
                dr["unitcost"] = hdnEnhancedeBookpageadditionalunit.Text;
                dr["totalcost"] = hdnEnhancedeBookpageadditionalunitscost.Text; 
                dtenhancedeBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txtEnhancedeBookcustpcdhplinks.Text))
            {
                ...
                dr["unitcost"] = hdnEnhancedeBooklinksadditionalunits.Text;
                dr["totalcost"] = hdnEnhancedeBooklinksadditionalunitscost.Text;
                dtenhancedeBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txtEnhancedeBookavcost.Text))
            {
                ...
                dr["unitcost"] = hdnEnhancedeBookavunitcost.Text;
                dr["totalcost"] = hdnEnhancedeBookavtotalcost.Text;
                dtenhancedeBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(txtEnhancedeBookReadaloud.Text))
            {
                ...
                dr["unitcost"] = hdnEnhancedeBookReadaloudunitcost.Text;
                dr["totalcost"] = hdnEnhancedeBookReadaloudtotalcost.Text;
                dtenhancedeBookcart.Rows.Add(dr);
            }
            else
            {
            ...
            Session["EnhancedeBookcarttotal"] = roundofdecimalpoints(Convert.ToDecimal(txtEnhanceeBookhdnPckCst.Text));
            ...
            decimal EnhancedeBookofferselected = Math.Ceiling((100 * EnhancedeBookdiscountonbasepkg) / getproductprice());
            Session["EnhancedeBookofferselected"] = EnhancedeBookofferselected.ToString();
