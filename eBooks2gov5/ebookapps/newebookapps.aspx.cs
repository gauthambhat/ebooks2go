...
{
    public partial class newebookapps : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    if (hidAccordionIndex.Value.ToString() == "0" && Session["dtsimpleebookappscart"]!=null)
                        bindsimpleebookappssessionvalues();
                    else if (hidAccordionIndex.Value.ToString() == "1" && Session["dtcomplexebookappscart"]!=null)
                        bindcomplexebookappssessionvalues();
                    else if (hidAccordionIndex.Value.ToString() == "2" && Session["dttextbookscart"] != null)
                        bindtextbookssessionvalues();
                }
        ...
        private decimal getpagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txtebookappssimpleebookappscustpages.Text))
            {
                if (Convert.ToInt32(txtebookappssimpleebookappscustpages.Text) > Convert.ToInt32(lblebookappssimpleebookappscustpages.Text))
                {
                    ...
                    hdnebookappssimpleebookappsadditonalpagesunitcost.Text = lblebookappssimpleebookappsadditonalpagesunitcost.Text;
                    hdnebookappssimpleebookappsadditionaltotalcost.Text = lblebookappssimpleebookappsadditionaltotalcost.Text;
                    return pageprice;
                }
                else
                {
        ...
        private decimal getcomplexebookappspagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txtebookappscomplexebookappscustpages.Text))
            {
                if (Convert.ToInt32(txtebookappscomplexebookappscustpages.Text) > Convert.ToInt32(lblebookappscomplexebookappscustpages.Text))
                {
                    ...
                    hdnebookappscomplexebookappsaddtionalpagesunitcost.Text = lblebookappscomplexebookappsaddtionalpagesunitcost.Text;
                    hdnebookappscomplexebookappsadditionalpagestotalcost.Text = lblebookappscomplexebookappsadditionalpagestotalcost.Text;
                    return pageprice;
                }
                else
                {
        ...
        private decimal getcomplexebookappsanimationpagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txtebookappscomplexebookappscustanimationpages.Text))
            {
                if (Convert.ToInt32(txtebookappscomplexebookappscustanimationpages.Text) > Convert.ToInt32(lblebookappscomplexebookappscustanimationpages.Text))
                {
                    ...
                    hdnebookappscomplexebookappsadditionalanimationpagesunitcost.Text = lblebookappscomplexebookappsadditionalanimationpagesunitcost.Text;
                    hdnebookappscomplexebookappsadditionalanimationpagestotalcost.Text = lblebookappscomplexebookappsadditionalanimationpagestotalcost.Text;
        ...
        private decimal getebookappsfortextbookspagevalues(int count)
        {
            if (!string.IsNullOrEmpty(txtebookappsfortextbookscustpages.Text))
            {
                if (Convert.ToInt32(txtebookappsfortextbookscustpages.Text) > Convert.ToInt32(lblebookappsfortextbookscustpages.Text))
                {
                    ...
                    hdnebookappsfortextbooksadditionalpagesunitcost.Text = lblebookappsfortextbooksadditionalpagesunitcost.Text;
                    hdnebookappsfortextbooksadditionalpagestotalcost.Text = lblebookappsfortextbooksadditionalpagestotalcost.Text;
                    return pageprice;
                }
                else
                {
        ...
        private decimal getebookappsfortextbooksinteracitve(int count)
        {
            if (!string.IsNullOrEmpty(txtebookappsfortextbookscustinteractiveandselfassessmentpages.Text))
            {
                if (Convert.ToInt32(txtebookappsfortextbookscustinteractiveandselfassessmentpages.Text) > Convert.ToInt32(lblebookappsfortextbookscustinteractiveselfassessmentpages.Text))
                {
                    ...
                    hdnebookappsfortextbooksadditionalinteractiveselfassessmentunitcost.Text = lblebookappsfortextbooksadditionalinteractiveselfassessmentunitcost.Text;
                    hdnebookappsfortextbooksadditionalinteractiveselfassessmenttotalcost.Text = lblebookappsfortextbooksadditionalinteractiveselfassessmenttotalcost.Text;
        ...
        private decimal getebookappsfortextbooksaudioandvideo(int count)
        {
            if (!string.IsNullOrEmpty(txtebookappsfortextbookscustavelements.Text))
            {
                if (Convert.ToInt32(txtebookappsfortextbookscustavelements.Text) > Convert.ToInt32(lblebookappsfortextbookscustavintergrationpages.Text))
                {
                    ...
                    hdnebookappstextbooksadditionalavelementsunitcost.Text = lblebookappstextbooksadditionalavelementsunitcost.Text;
                    hdnebookappstextbooksadditionalavelementstotalcost.Text = lblebookappstextbooksadditionalavelementstotalcost.Text;
        ...
        private void ebookappscalculation()
        {
            ...
            //{
                ...
                if (count > 0)
                {
                    ...
                    hdnebookappssimpleebookappspackagecost.Text = txtebookappssimpleebookappspackagecost.Text;
            ...
            //{
                ...
                if (count > 0)
                {
                    ...
                    hdnebookappscomplexebookappspackagecost.Text = txtebookappscomplexebookappspackagecost.Text;
            ...
            //{
                ...
                if (count > 0)
                {
                    ...
                    hdnebookappsfortextbookspackagecost.Text = txtebookappsfortextbookspackagecost.Text;
        ...
        protected void imgbtnsimpleproceed_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (ib.ID == "imgbtnsimpleproceed")
            {
                ...
                Response.Redirect("~/ebookapps/flupload.aspx?ID=3");
            ...
            else if (ib.ID == "imgbtncomplexproceed")
            {
                ...
                Response.Redirect("~/ebookapps/flupload.aspx?ID=4");
               
            }
            else
            {
                storeinCarttextbooks();
                Response.Redirect("~/ebookapps/flupload.aspx?ID=5");
        ...
        {
            switch (Convert.ToInt16(hidAccordionIndex.Value.ToString())) //here hiddenfiled capture the value of accordian tab pane.
            {
        ...
        private void storeinCartsimpleebookapps()
        {
            ...
            //Session["dtcomplexebookappscart"] = null;
            //Session["dttextbookscart"] = null;
            //Session["accIndex"] = null; 
        ...
        private void addtosession(DataTable dtsimpleebookappscart)
        {
            ...
            if (!string.IsNullOrEmpty(txtebookappssimpleebookappscustpages.Text))
            {
                ...
                dr["unitcost"] = hdnebookappssimpleebookappsadditonalpagesunitcost.Text;
                dr["totalcost"] = hdnebookappssimpleebookappsadditionaltotalcost.Text;
                dtsimpleebookappscart.Rows.Add(dr);
            }
            else
            {
            ...
            Session["simpleeBookappscarttotal"] = roundofdecimalpoints(Convert.ToDecimal(hdnebookappssimpleebookappspackagecost.Text)); //calculate the simple ebook apps total and                                                                                                                                         store it in session
            ...
            decimal simpleebookappsdiscountonbasepkg = getproductprice((int)bel.bel.prodcategory.simpleebookapps) - baseprice;
            //here we get the offerseleted price and store that offerselected discount in session start
            decimal simpleeBookappsofferselected = Math.Ceiling((100 * simpleebookappsdiscountonbasepkg) / getproductprice((int)(bel.bel.prodcategory.simpleebookapps)));
            Session["simpleebookappsBookofferselected"] = simpleeBookappsofferselected.ToString();
            //here we get the offerseleted price and store that offerselected discount in session end
        ...
        private void addtocomplexebookappssession(DataTable dtcomplexebookappscart)
        {
            ...
            if (!string.IsNullOrEmpty(txtebookappscomplexebookappscustpages.Text))
            {
                ...
                dr["unitcost"] = hdnebookappscomplexebookappsaddtionalpagesunitcost.Text;
                dr["totalcost"] = hdnebookappscomplexebookappsadditionalpagestotalcost.Text;
                dtcomplexebookappscart.Rows.Add(dr);
                custcount++;
            }
            else
            ...
            if (!string.IsNullOrEmpty(txtebookappscomplexebookappscustanimationpages.Text))
            {
                ...
                dr["unitcost"] = hdnebookappscomplexebookappsadditionalanimationpagesunitcost.Text;
                dr["totalcost"] = hdnebookappscomplexebookappsadditionalanimationpagestotalcost.Text;
                dtcomplexebookappscart.Rows.Add(dr);
                custcount++;
            }
            else
            ...
            Session["complexeBookappscarttotal"] = roundofdecimalpoints(Convert.ToDecimal(hdnebookappscomplexebookappspackagecost.Text)); //calculate the simple ebook apps total and                                                                                                                                         store it in session
            ...
            decimal complexebookappsdiscountonbasepkg = getproductprice((int)(bel.bel.prodcategory.complexebookapps)) - baseprice;

            //here we get the offerseleted price and store that offerselected discount in session start
            decimal complexeBookappsofferselected = Math.Ceiling((100 * complexebookappsdiscountonbasepkg) / getproductprice((int)(bel.bel.prodcategory.complexebookapps)));
            Session["complexeBookappsofferselected"] = complexeBookappsofferselected.ToString();
            //here we get the offerseleted price and store that offerselected discount in session end
            ...
            Session["complexebookappsproductprice"] = roundofdecimalpoints(getproductprice((int)(bel.bel.prodcategory.complexebookapps)));//estimated product value
        ...
        private void addtotextbookssession(DataTable dttextbookscart)
        {
            ...
            if (!string.IsNullOrEmpty(txtebookappsfortextbookscustpages.Text))
            {
                ...
                dr["unitcost"] = hdnebookappsfortextbooksadditionalpagesunitcost.Text;
                dr["totalcost"] = hdnebookappsfortextbooksadditionalpagestotalcost.Text;
                dttextbookscart.Rows.Add(dr);
                custcount++;
            }
            else
            ...
            if (!string.IsNullOrEmpty(txtebookappsfortextbookscustinteractiveandselfassessmentpages.Text))
            {
                ...
                dr["unitcost"] = hdnebookappsfortextbooksadditionalinteractiveselfassessmentunitcost.Text;
                dr["totalcost"] = hdnebookappsfortextbooksadditionalinteractiveselfassessmenttotalcost.Text;
                dttextbookscart.Rows.Add(dr);
                custcount++;
            }
            else
            ...
            if (!string.IsNullOrEmpty(txtebookappsfortextbookscustavelements.Text))
            {
                ...
                dr["unitcost"] = hdnebookappstextbooksadditionalavelementsunitcost.Text;
                dr["totalcost"] = hdnebookappstextbooksadditionalavelementstotalcost.Text;
                dttextbookscart.Rows.Add(dr);
                custcount++;
            }
            else
            ...
            Session["textbookscarttotal"] = roundofdecimalpoints(Convert.ToDecimal(hdnebookappsfortextbookspackagecost.Text)); //calculate the simple ebook apps total and                                                                                                                                         store it in session
            ...
            decimal textbooksdiscountonbasepkg = getproductprice((int)(bel.bel.prodcategory.eBookappsfortextbooks)) - baseprice;

            //here we get the offerseleted price and store that offerselected discount in session start
            decimal textbooksofferselected = Math.Ceiling((100 * textbooksdiscountonbasepkg) / getproductprice((int)(bel.bel.prodcategory.eBookappsfortextbooks)));
            Session["textbooksofferselected"] = textbooksofferselected.ToString();
            //here we get the offerseleted price and store that offerselected discount in session end
            ...
            Session["textbooksproductprice"] = roundofdecimalpoints(getproductprice((int)(bel.bel.prodcategory.eBookappsfortextbooks)));//estimated product value
