<%--we are using this page instead of textbookscart.aspx--%>


<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="textbooksfinalcart.aspx.cs" Inherits="eBooks2goV5.ebookapps.textbooksfinalcart" %>
...
<body>
            ...
            <table id="tabEbook1" width="1000" border="1" bordercolor="#E1E1E1" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <asp:Panel ID="pnlqty" Visible='<%# enablevisible(Eval("productid"))%>' runat="server">
                                <td align="center">
                                    ...
                                    <asp:Label ID="lbltextbooksipadquantity" runat="server"><%# Eval("qty") %></asp:Label>
                                </td>
                                <td align="center">

                                    <asp:Label ID="lbltextbooksipadunitcost" runat="server"><%# Eval("unitcost") %></asp:Label>
                                </td>
                                <td align="center">

                                    <asp:Label ID="lbltextbooksipadtotalcost" runat="server"><%# Eval("totalcost") %></asp:Label>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:Label ID="lbltextbookscustpagesquantity" runat="server"><%# Eval("qty") %></asp:Label>
                                    </td>
                                    <td align="center">

                                        <asp:Label ID="lbltextbookscustpagesunitcost" runat="server"><%# Eval("unitcost") %></asp:Label>
                                    </td>
                                    <td align="center">

                                        <asp:Label ID="lbltextbookscustpagestotalcost" runat="server"><%# Eval("totalcost") %></asp:Label>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                ...
                <tr>
                    <td colspan="5" align="right">
                        ...
                        &nbsp; &nbsp;
                        <asp:ImageButton ID="imgbtncheckout" runat="server"  Visible="false"  OnClick="imgbtncheckout_Click" src="images/checkout_btn.jpg" width="117" height="30" alt="check out" /></td>
                </tr>
    ...
    <div id="modal_dialog" style="display: none;height:320px; width:800px;">
        <iframe id="Iframe1" runat="server" src="../../signin/signin.aspx?ID=5" style="height:320px; width:380px;" noresize="noresize" frameborder="0" scrolling="no" border="0" />
    </div>
